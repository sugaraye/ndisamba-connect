...
export async function POST(request) {
  try {
    ...
    // Traiter l'update sans attendre (répondre vite à Telegram)
...
export async function GET() {
  // Route simple pour tester si le webhook fonctionne
  const bot = getBot();
  const status = bot ? "Bot initialisé" : "Bot non initialisé (BOT_TOKEN manquant)";
...
// ⚠️ DÉSACTIVER LE PRÉ-RENDU PENDANT LE BUILD
expor

t const dynamic = 'force-dynamic';
